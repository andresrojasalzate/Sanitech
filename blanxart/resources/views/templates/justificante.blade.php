...
<body class="body-justificante">
    <div class="justificante">
        ...
        <div>Data: {{ $cita->date }}</div>
        <div>Hora inici d'atenció: {{ $cita->time }}</div>
        ...
        <div class="justificant-horaImpresion">Data i hora impressió justificant: {{ now() }}</div>
    </div>
</body>
</html>
