...
Así, Lo primero que hemos de hacer es localizar la carpeta docker_config en el proyecto. Desde la raíz del repositorio GIT, la ruta es `~/docker/`. Dentro encontraremos el fichero: `docker-compose.yml`. 
